...
vegetables and fruits aisle is the next most popular aisle, but this
aisle is not nearly as popular as the fresh produce
aisles.
...
items ordered from them, with the exception of the aisles in th table
...
that “packaged vegetables fruits” is one of the most bought from aisles.
